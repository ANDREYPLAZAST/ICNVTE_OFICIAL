      ...
      <header className={`fixed w-full top-0 z-50 transition-all duration-300 ${
        ...
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 lg:px-8 py-3" aria-label="Global">
            ...
            <Link href="/" className="group flex items-center space-x-3">
              <div className="relative">
                ...
                <div className="w-12 h-12 rounded-lg overflow-hidden relative">
                  {/* Logo para fondo blanco (cuando hay scroll) */}
                  <Image
          ...
          <div className="flex lg:hidden">
            <button
              type="button"
              className={`relative inline-flex items-center justify-center rounded-lg p-2.5 transition-colors duration-200 ${
                isScrolled 
                  ? 'text-gray-700 hover:text-slate-800 bg-gray-100 hover:bg-gray-200' 
